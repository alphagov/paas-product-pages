        ...
        <div className="govuk-grid-row">
          <div className="masthead__body govuk-grid-column-two-thirds">
            ...
            <p className="govuk-!-margin-bottom-5 masthead__description">
              If you work in the public sector, use GOV.UK Platform as a Service to host your services without worrying about infrastructure.
            </p>
            <Button 
              href="/get-started" 
              isStartButton 
            ...
            <span class="hero-alternative-action">
              or <a href="/features/">find out what GOV.UK PaaS offers</a>
            </span>
          </div>
