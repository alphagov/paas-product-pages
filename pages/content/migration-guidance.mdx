...
Removing the domain and re-adding it to your new distribution will cause your website to go down. Unfortunately cloudfront changes can take 5-20 mins to apply changes. AWS support can cutover your domain instantly, however you will still get a small amount downtime as you cutover the DNS yourself.
