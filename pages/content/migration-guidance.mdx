...
- 1st November 2022 - first published
...
Tenants should look to their own department, or parent department, and use existing patterns and support available for public cloud hosting services. 
...
### What does this mean for me and my service(s)?
...
### Timeline for decommissioning GOV.UK PaaS
...
<th scope="col" class="govuk-table__header">What this means for you</th>
</tr>
</thead>
<tbody class="govuk-table__body">
<tr class="govuk-table__row">
<td class="govuk-table__cell">Announcement of the decision to decommission</td>
<td class="govuk-table__cell">12 July 2022</td>
<td class="govuk-table__cell">Public notification of the decision to decommission the platform and
...
<tr class="govuk-table__row">
<td class="govuk-table__cell">Festive season code freeze</td>
<td class="govuk-table__cell">16 December 2022 until 9 January 2023</td>
<td class="govuk-table__cell">Annual platform freeze over the festive period for non essential
engineering. This should not affect you.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Deprecation of PostgreSQL 10 plans</td>
<td class="govuk-table__cell">7 February 2023</td>
<td class="govuk-table__cell">From this date we will be deprecating all our PostgreSQL 10 plans.
...
<tr class="govuk-table__row">
<td class="govuk-table__cell">End of the financial year</td>
<td class="govuk-table__cell">31 March 2023</td>
<td class="govuk-table__cell">After this date you may have additional funds available from your
department to help the migration.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Automatic upgrade of PostgreSQL 10 databases to PostgreSQL 14</td>
<td class="govuk-table__cell">17/04/2023 - 18/07/2022</td>
<td class="govuk-table__cell">From 17th April and 18th July any PostgreSQL 10 plans will be
automatically upgraded to PostgreSQL 14 by AWS during a maintenance
window. GOV.UK PaaS has no plans to offer Postgres 14. This change may
...
<tr class="govuk-table__row">
<td class="govuk-table__cell">Deprecation of Redis 3</td>
<td class="govuk-table__cell">30 June 2023</td>
<td class="govuk-table__cell">From this date we will be deprecating all our Redis 3 plans. You
...
<tr class="govuk-table__row">
<td class="govuk-table__cell">Forced upgrade of PostgreSQL 10 databases to PostgreSQL 14</td>
<td class="govuk-table__cell">18 July 2023</td>
<td class="govuk-table__cell">From this date AWS will force the upgrade of PostgreSQL 10 databases
to PostgreSQL 14, regardless of maintenance window. This change may
break your application.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Final bills issued by GDS Business Operations</td>
<td class="govuk-table__cell">2022 Q4</td>
<td class="govuk-table__cell">You will receive your final bill.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">GOV.UK PaaS decommission</td>
<td class="govuk-table__cell">23 December 2023</td>
<td class="govuk-table__cell">After this date services hosted on the platform will stop operating
or responding to requests from the web. The GOV.UK PaaS API will not
respond to requests.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Deletion of tenant data and GOV.UK PaaS platform data</td>
<td class="govuk-table__cell">28 February 2024</td>
<td class="govuk-table__cell">After this date all tenant and platform data will be destroyed.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Deadline to pay final bills</td>
<td class="govuk-table__cell">31st March 2024</td>
<td class="govuk-table__cell">You must pay any outstanding bills by this date.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">End of financial year 2023/2024</td>
<td class="govuk-table__cell">31 March 2024</td>
<td class="govuk-table__cell">The end of the financial year</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Deletion of tenant data and paas platform data</td>
<td class="govuk-table__cell">2024 Q1</td>
<td class="govuk-table__cell">Your data will be finally deleted</td>
</tr>
</tbody>
</table>
...
The GOV.UK PaaS platform will be maintained to the usual standards until decommissioned. This includes monthly buildpack upgrades, security patches, and the annual platform pentest and IT health check. You will receive regular communications from the GOV.UK PaaS team via email.
...
<thead class="govuk-table__head">
<tr class="govuk-table__row">
<th scope="col" class="govuk-table__header">Maintenance</th>
...
<tbody class="govuk-table__body">
<tr class="govuk-table__row">
<td class="govuk-table__cell">Monthly buildpack upgrades</td>
<td class="govuk-table__cell">regular upgrades, typically monthly</td>
<td class="govuk-table__cell">Regular communication from the GOV.UK PaaS team highlighting any
major changes to language support, deprecations.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Ad hoc security patches</td>
<td class="govuk-table__cell">as required within 5 days of reporting</td>
<td class="govuk-table__cell">The platform will be maintained to our usual standards for security
patching until it is retired.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">Annual platform pentest</td>
<td class="govuk-table__cell">Q4 of each year</td>
<td class="govuk-table__cell">The platform will be assured to the usual standards until it is
demised. This means annual health checks and remediation of any priority
findings.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">monthly paas-announce email to tenants</td>
<td class="govuk-table__cell">regular monthly updates</td>
<td class="govuk-table__cell">Regular communication from GOV.UK PaaS team highlighting any key
milestones or guidance for tenants.</td>
</tr>
<tr class="govuk-table__row">
<td class="govuk-table__cell">PaaS IT Health Check for 2023/2024</td>
<td class="govuk-table__cell">Q4 2022</td>
<td class="govuk-table__cell">Annual health check for the coming year to ensure we are
...
### Support from the GOV.UK PaaS team during the decommissioning process 

We intend to maintain the service as it has been until the end of December 2023. Unless you no longer require your service, it must have been migrated before this date. GDS will continue to provide a team of site reliability engineers to perform critical platform operations and [timely support](https://team-manual.cloud.service.gov.uk/incident_management/support_manual/)

We will continue to offer help and advice though our usual channels:

1. [GOV.UK PaaS Team (support form)](https://admin.london.cloud.service.gov.uk/support/contact-us) for platform tenants who have questions about migration.

2. [cross government slack slack #govuk-paas](https://ukgovernmentdigital.slack.com/archives/C33SAH4GJ) channel for tenants using the cross government slack https://ukgovernmentdigital.slack.com

3. GDS slack [#paas](https://gds.slack.com/archives/CADHV9267) channel for internal users
...
These are just some examples rather than endorsements.
...
<thead class="govuk-table__head">
<tr class="govuk-table__row">
<th scope="col" class="govuk-table__header">Guidance</th>
<th scope="col" class="govuk-table__header">Description</th>
</tr>
</thead>
<tbody class="govuk-table__body">
<tr class="govuk-table__row">
<td class="govuk-table__cell">[Government Cloud First
Policy](https://www.gov.uk/guidance/government-cloud-first-policy)</td>
<td class="govuk-table__cell">The government introduced a ‘Cloud First’ policy in 2013 for all
technology decisions.</td>
</tr>

<tr class="govuk-table__row">
<td class="govuk-table__cell">[Technical code of
practice](https://www.gov.uk/guidance/the-technology-code-of-practice) <br/> [Point 5: Use cloud
first](https://www.gov.uk/guidance/use-cloud-first)</td>
<td class="govuk-table__cell">The Technology Code of Practice is a set of criteria to help public
sector organisations design, build and buy technology.</td>
</tr>

<tr class="govuk-table__row">
<td class="govuk-table__cell">[Service
Standard](https://www.gov.uk/service-manual/service-standard)  <br/> [9. Create
...
<tr class="govuk-table__row">
<td class="govuk-table__cell">[Service Manual](https://www.gov.uk/service-manual)
[Technology](https://www.gov.uk/service-manual/technology)</td>
<td class="govuk-table__cell">Helping teams to create and run great public services that meet the
Service Standard.</td>
</tr>

<tr class="govuk-table__row">
<td class="govuk-table__cell">[CDDO Creating and implementing a cloud hosting
strategy](https://www.gov.uk/guidance/creating-and-implementing-a-cloud-hosting-strategy)</td>
<td class="govuk-table__cell">This guidance outlines how to create and implement a cloud strategy,
and when to consider a single, hybrid or multi-cloud solution.</td>
</tr>

<tr class="govuk-table__row">
<td class="govuk-table__cell">[NCSC cloud security
...
<tr class="govuk-table__row">
<td class="govuk-table__cell">Any department level guidance</td>
<td class="govuk-table__cell">e.g. the DFE technical guidance.</td>
</tr>
</tbody>
</table>
...
Is this guidance useful?  <a href="mailto:gov-uk-paas-support@digital.cabinet-office.gov.uk?subject=[migration-guidance]+useful:YES&body=Please tell us why you found the guidance helpful and if anything can be improved">Yes</a>  <a href="mailto:gov-uk-paas-support@digital.cabinet-office.gov.uk?subject=[migration-guidance]+useful:NO&body=Please tell us why you found the guidance unhelpful and what could be added to improve the guidance"> No</a> or raise a [GitHub issue](https://github.com/alphagov/paas-product-pages/issues/new?title=[Migration+guidance]+-+enter+a+title&body=feedback+for+the+GOV.UK+PaaS+migration+guidance) to give us feedback
