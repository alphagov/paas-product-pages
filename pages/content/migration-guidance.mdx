...
- 2023-08-15 - new guidance section ['Publishing static pages to GitHub Pages'](#publishing-static-pages-to-github-pages)
- 2023-05-18 - new guidance section ['Finalise your GOV.UK PaaS account'](#finalise-your-govuk-paas-account)
- 2023-01-05 - new guidance section ['PaaS CDB Migration'](#paas-cdn-migration) 
- 2022-11-02 - new guidance first publication
...
The [GDS technical writers]() provide a commonly used tool to generate static documentation from templates called the [Tech Doc Templates](https://tdt-documentation.london.cloudapps.digital/). 
