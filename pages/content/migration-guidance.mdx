...
Removing the domain and re-adding it to your new AWS Cloudfront Distribution will cause your website to go down. Unfortunately changes to AWS Cloudfront can take between 5 and 20 minutes to apply. AWS support can cutover your domain instantly, however you will still get a small amount downtime as you cutover the DNS yourself.
