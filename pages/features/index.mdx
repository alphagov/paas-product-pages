...
-   simplified user account management and support for single sign-on with your organisationâ€™s Google and Microsoft accounts
...
-   application isolation so that they canâ€™t read or change each other's code, data or logs
...
GOV.UK PaaS requires that your application is built to meet modern standards. Itâ€™s easier to migrate to GOV.UK PaaS if your application is â€œ[cloud native](https://thenewstack.io/10-key-attributes-of-cloud-native-applications/)â€ and built using [12 factor application principles](https://docs.cloud.service.gov.uk/architecture.html#12-factor-application-principles).
...
We monitor the infrastructure and manage the patching of the platformâ€™s operating systems and infrastructure components. When we update the platform, we use zero downtime deploys, so this won't interfere with the running of your application.
